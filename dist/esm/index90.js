...
class HederaSCSPlugin extends BasePlugin {
  constructor() {
    super(...arguments);
    this.id = "hedera-scs";
    this.name = "Hedera Smart Contract Service Plugin";
    this.description = "Provides tools for interacting with the Hedera Smart Contract Service (SCS).";
    this.version = "1.0.0";

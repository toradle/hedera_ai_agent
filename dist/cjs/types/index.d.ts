...
import { PublicKey, AccountId, TopicId, PrivateKey, CustomFee, TokenType, TokenSupplyType, TokenId, Long, NftId, CustomFixedFee, Key, FileId, ContractFunctionParameters, KeyList, ContractId, Hbar, EvmAddress, PendingAirdropId, TransactionId, ScheduleId } from '@hashgraph/sdk';
export { PublicKey, AccountId, TopicId, PrivateKey, CustomFee, TokenType, TokenSupplyType, TokenId, Long, NftId, CustomFixedFee, Key, FileId, ContractFunctionParameters, KeyList, ContractId, Hbar, EvmAddress, PendingAirdropId, TransactionId, ScheduleId, };
...
export declare enum AgentKitActionName {
...
export interface UpdateFileParams {
    ...
    keys?: Array<string | Key | KeyList> | null;
